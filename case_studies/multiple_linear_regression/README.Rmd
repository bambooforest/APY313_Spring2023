...
Recall that multiple linear regression is used to estimate the relationship between **two or more independent variables** and **one dependent variable**. 
...
The estimated effect of biking on heart disease is -0.2 and the estimated effect of smoking is 0.178.
...
But what can we say about the relationship between biking and smoking on heart disease?
