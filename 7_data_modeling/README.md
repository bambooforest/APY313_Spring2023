...
We can quickly visualize our variables.
...
To answer which kind of statistical test you should:

- **first ask: what kind of distribution does your data follow?**

Different tests assume different distributions. In other words, how is
your data shaped? Hont: visualize it!
