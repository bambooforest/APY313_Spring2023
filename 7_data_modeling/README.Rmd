...
Different tests assume different distributions. In other words, how is your data shaped? Hont: visualize it!

And like our [discussion on which plots to use](https://github.com/bambooforest/IntroDataScience/tree/main/6_data_visualization#which-plots-to-use) to visualize you data:
